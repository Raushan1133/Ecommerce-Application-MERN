    ...
    <form onSubmit={handleSubmit} className='grid p-4 gap-3 h-full overflow-y-scroll pb-5'>
      ...
      <div className='p-2 cursor-pointer bg-slate-100 border rounded h-32 w-full flex justify-center items-center'>
          ...
          <FaCloudUploadAlt />
              ...
              <input type="file" name='uploadImageInput'  id="uploadImageInput" className='hidden' onChange={handleUploadProduct} />
          </div>
      </div>
          </label>
      <div>
                          ...
                          data.productImage.map((el,index)=>{
                              return(
                                  <div className='relative group'>
                                      <img src={el} width={80} height={80} className='bg-slate-100 cursor-pointer rounded' alt={el} onClick={()=>{
      ...
      <button className='px-2 py-2 mb-10 bg-red-600 text-white hover:bg-red-700'>Update Product</button>
    </form>
    </div>
